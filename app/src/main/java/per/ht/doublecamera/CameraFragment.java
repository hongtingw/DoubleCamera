...
public class CameraFragment extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void setArguments(@Nullable Bundle args) {
        ...
        if (args != null) {
            mViewId = args.getInt("view_id");
            mLensFacing = args.getInt("lens_facing");
        }
    }
    ...
    public static CameraFragment newInstance(int viewId, int lens_facing) {
        Bundle args = new Bundle();
        args.putInt("view_id", viewId);
        args.putInt("lens_facing", lens_facing);
    ...
    public void onViewCreated(@NonNull final View view, Bundle savedInstanceState) {
        ...
        mTextureView = view.findViewById(mViewId);
    }
    ...
    public void onResume() {
        ...
        if (null == mTextureView) {
            Log.e(TAG, "onResume called when mTextureView is still null");
            return;
        }
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                Log.e(TAG, "Error when setting repeating preview capture request", e);
                            }
                        }
